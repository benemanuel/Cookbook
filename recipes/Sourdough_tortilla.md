...
ingredients:
  ...
  - 3 g salt
steps:
  - In a large bowl, mix the sourdough discard, olive oil, and water and stir to combine.
  - Add the all-purpose flour and salt, mixing until the dough is formed.
  - Knead for 1 to 2 minutes until everything is well combined and the dough looks homogeneous with no dry spots.
  - If the dough is too sticky, add 1 tablespoon more all-purpose flour and knead until absorbed.
  - Cover the dough with a damp towel and let it rest for 30 minutes.
  - Preheat a large skillet on high heat.
  - Lightly flour the surface you will use for rolling the dough.
  - Divide the dough into 8 to 10 pieces and flatten each ball with the palm of your hand.
...
8. Divide the dough into 8 to 10 pieces and flatten each ball with the palm of your hand.
9. Roll each piece of dough into a thin circle using a rolling pin or wine bottle, about 1/4 inch thickness.
10. Cook each tortilla individually on high heat for about 1 minute on each side, flipping as soon as bubbles appear and the edges look firm.
11. Allow the tortillas to cool before storing in an airtight container and serve warm.
