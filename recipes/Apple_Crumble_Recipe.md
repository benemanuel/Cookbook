...
steps:
  ...
  - Mix the butter or margarine with the flour in a dry bowl using a fork until the mixture resembles breadcrumbs, taking about three minutes.
  - If adding optional oatmeal or Corn Flakes, mix them in now.
  - Add 4 ounces of sugar to the mixture and mix it all together with the fork.
  - Peel the apples and cut each one into four parts, then cut out the core from each section.
  - Slice the apple quarters into about six slices per section.
  - Put the apple slices into the casserole dish and sprinkle with cinnamon if using.
  - Sprinkle the remaining 2 ounces of sugar evenly over the apples.
  - Evenly spread the crumble mixture over the sugared apples.
  - Place the dish into the preheated oven for around 40 minutes.
...
12. Leave the crumble to cool for at least 15 minutes before serving.
13. Serve hot or cold with ice cream, cream, or custard.
